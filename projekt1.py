    ...
    while True :
        ...
        if wybor == "1" :
            ...
            if wydarzenie <= 30 :
                ...
                rodzaj_zdarzenia = random.choice(["zloto", "sadzonki2", "eliksiry_many", "eliksir_zycia", "eliksir2"])
                if rodzaj_zdarzenia  == "zloto" :
                    zloto = random.randint(10,25)
                    gold += zloto 
                ...
                elif rodzaj_zdarzenia == "eliksiry_many" :
                    eliksiry_many = random.randint(10,30) 
                    mana += eliksiry_many 
                    print(f"Znalazles {eliksiry_many} potki many")
                elif rodzaj_zdarzenia == "eliksir_zycia" :
                    eliksir_zycia = random.randint(50,100)
                    life += eliksir_zycia 
                    print(f"Zdobyles {eliksir_zycia} hp")
                elif rodzaj_zdarzenia == "eliksir2" :
                    eliksir2 = random.randint(1,3)
                    eliksir += eliksir2
                    print(f"Zdobyles {eliksir2} potki")
        elif wybor == "2" :
